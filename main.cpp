...
using namespace std;
 ...
 int main() {
     ...
     while (true) {
         ...
         cout << "4 Pasirinkimas - tai isejimas is programos" << endl;
         //Vartotojo ivestis: pasirinkimas ir valiuta
         cout << "Pasirinkite norima veiksma (1-4)" << endl;
         cin >> Pasirinkimas;
         if (Pasirinkimas == 4) {
             cout << "Isejimas" << endl;
             break;
         }else if (Pasirinkimas >= 1 && Pasirinkimas <= 3) {
             ...
             switch (Pasirinkimas) {
                 ...
                 case 3:
                     ...
                     switch (Valiuta) {
                         case 1: {
                             cout << "Kiek GBP norite parduot?" << endl;
                             float Kiekis;
                             cin >> Kiekis;
                             float gauti_EUR = Kiekis / GBP_Parduoti;
                             cout << fixed << setprecision(2) << endl;
                             cout << "Už " << Kiekis << " GBP, jus gausite " << gauti_EUR << " EUR." << endl;
                             break;
                         }
                         case 2: {
                             cout << "Kiek USD norite parduot?" << endl;
                             float Kiekis;
                             cin >> Kiekis;
                             float gauti_EUR = Kiekis / USD_Parduoti;
                             cout << fixed << setprecision(2) << endl;
                             cout << "Už " << Kiekis << " USD, jus gausite " << gauti_EUR << " EUR." << endl;
                             break;
                         }
                         case 3: {
                             cout << "Kiek INR norite parduot?" << endl;
                             float Kiekis;
                             cin >> Kiekis;
                             float gauti_EUR = Kiekis / INR_Parduoti;
                             cout << fixed << setprecision(2) << endl;
                             cout << "Už " << Kiekis << " INR, jus gausite " << gauti_EUR << " EUR." << endl;
                             break;
                         }
                     }
                     break;
